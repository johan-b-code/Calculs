...
namespace Calculs
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bool correct; //,memoriser si la saisie est un entier
            ...
            while (choix != "0")
            {
                ...
                switch (choix) // traitement des choix 
                {
                    case "1":  // choix de l'addition
                        ...
                        while (!correct)
                            try
                            {
                                ...
                                reponse = int.Parse(Console.ReadLine());// comparaison avec la bonne réponse
                                correct = true;
                            }
                            catch
                            {
                    ...
                    default:// autre valeur donc erreur de saisie
                        Console.WriteLine("erreuer de saisie");
                        break;
